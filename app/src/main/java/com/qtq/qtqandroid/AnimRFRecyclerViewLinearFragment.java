 ...
 */
public class AnimRFRecyclerViewLinearFragment extends Fragment {
    ...
    public AnimRFRecyclerViewLinearFragment() {
//        addData();
        datas = new ArrayList<>();
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (mRecyclerView == null) {
            ...
            // 头部
            headerView = LayoutInflater.from(getActivity()).inflate(R.layout.recycler_header_view, null);
            // 脚部
            footerView = LayoutInflater.from(getActivity()).inflate(R.layout.recycler_footer_view, null);
